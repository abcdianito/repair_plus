...
class ElectronicTutorialsScreen extends StatelessWidget {
  @override
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'An expensive variety of repair guides for electronic gear, ranging from home and car audio to calculators',
                      style: TextStyle(
  ...
  Widget _buildCategoriesGrid(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        _buildCategoryCard(
          context: context,
          imagePath: 'assets/images/parts_tools.jpg',
